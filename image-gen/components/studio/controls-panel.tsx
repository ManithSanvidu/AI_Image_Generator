    ...
    <section className="studio-panel rounded-[2rem] border p-5 sm:p-7">
      ...
      <div className="studio-panel-inset mt-7 rounded-[1.8rem] border p-5">
        <div className="flex items-center justify-between gap-3">
          <p className="text-[1.05rem] font-semibold text-foreground">3. Image model</p>
        ...
        <div className="mt-4 relative">
          <select
            value={selectedModel}
            onChange={(event) => selectModel(event.target.value as ImageGenerationModel)}
            className={cn(
        ...
        <p className="mt-3 text-sm leading-6 text-muted-foreground">
          This uses your configured Hugging Face image model endpoint for generation.
        </p>
      </div>
